  ...
  <q-list class="myFlex">
    ...
    <q-item>
      <q-item-section>
        ...
        <q-item-label caption lines="2"
          >{{ row.creator ? row.creator : "" | filterAuthor }}
        </q-item-label>
      </q-item-section>
    </q-item>
    ...
    <q-item>
      ...
      <q-item-section
        side
        top
        @click.prevent="$router.push('/admin/users/' + row.id)"
      >
        <q-item-label caption style="color: teal; cursor: pointer"
          >View details</q-item-label
        >
