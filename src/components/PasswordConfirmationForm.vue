...
export default {
  ...
  computed: {
    password: {
      get() {
        return this.$store.getters["password_confirmation/fetchPassword"];
      },
      set(value) {
        this.$store.commit("password_confirmation/UPDATE_PASSWORD", value);
      }
    },
    confirm_password: {
      get() {
        return this.$store.getters[
          "password_confirmation/fetchConfirmPassword"
        ];
      },
      set(value) {
        this.$store.commit(
          "password_confirmation/UPDATE_CONFIRM_PASSWORD",
          value
        );
      }
    }
