       ...
       <q-card flat >
            ...
            <div class="q-mt-md"></div>
             ...
             <q-card-section class="q-pt-none">
               <q-select color="grey-3" outlined :dense="dense"  v-model="name" :options="$store.state.seed_banks.dependencies.names" label="Name" readonly>
                </q-select>
              </q-card-section>

             <q-card-section class="q-pt-none">
                <q-select readonly color="grey-3" outlined :dense="dense"  v-model="measurement" :options="$store.state.seed_banks.dependencies.measurements" label="Measurement">
                </q-select>
              </q-card-section>
...
<script>
export default {
    name: "SeedBanksCropCategoriesUpdateForm",
     data() {
    return {
       dense: true,
       visible: true,
  ...
  methods: {
    update(){ this.$store.dispatch('seed_banks/updateCropCategory',this); },
