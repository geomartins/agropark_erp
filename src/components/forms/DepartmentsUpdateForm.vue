       ...
       <q-card flat >
              ...
              <q-card-section>
                  <q-list bordered padding style="background: #cccccc52">
                    <q-item>
                      <q-item-section>
                           <q-item-label>Department Edit Form</q-item-label>
                        <q-item-label overline>Kindly edit the department details</q-item-label>
...
export default {
  ...
  methods: {
    update(){ this.$store.dispatch('departments/update',this); },
