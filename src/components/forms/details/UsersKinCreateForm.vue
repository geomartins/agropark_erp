    ...
    <q-card flat>
      ...
      <q-card-section class="q-pt-none">
        <q-select
          ...
          v-model="occupation"
          :options="
            $store.state.users_details.dependencies.user.occupations.split(',')
          "
          label="Occupation"
        >
        </q-select>
      ...
      <q-card-section class="q-pt-none">
        <q-select
          ...
          :options="
            $store.state.users_details.dependencies.user.relationships.split(
              ','
            )
          "
          label="Relationship"
...
export default {
  ...
  methods: {
    ...
    create() {
      this.$store.dispatch("users_details/createKin", this);
    },
    close() {
