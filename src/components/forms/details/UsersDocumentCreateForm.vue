    ...
    <q-card flat>
      ...
      <q-card-section class="q-pt-none">
        <q-select
          ...
          :dense="dense"
          v-model="type"
          :options="$store.state.users_details.dependencies.user.document_types.split(',')"
...
export default {
  ...
  computed: {
    type: {
      get() {
        return this.$store.getters["users_details/fetchDocumentType"];
      },
      set(value) {
        this.$store.commit("users_details/UPDATE_DOCUMENT_TYPE", value);
      }
    },
    description: {
      get() {
        return this.$store.getters["users_details/fetchDocumentDescription"];
      },
      set(value) {
        this.$store.commit("users_details/UPDATE_DOCUMENT_DESCRIPTION", value);
      }
    }
  },
  methods: {
    ...
    async create() {
      this.$store
        .dispatch("users_details/createDocument", {
          instance: this,
          files: this.files
        })
        .then(() => {
