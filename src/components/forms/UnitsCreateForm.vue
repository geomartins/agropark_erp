       ...
       <q-card flat >
              ...
              <q-card-section>
                  <q-list bordered padding style="background: #cccccc52">
                    <q-item>
                      <q-item-section>
                           <q-item-label>Units Form</q-item-label>
                        <q-item-label overline>Fill in the form to create new unit</q-item-label>
...
export default {
  ...
  methods: {
    create(){ this.$store.dispatch('units/create',this); },
  }
}
</script>
