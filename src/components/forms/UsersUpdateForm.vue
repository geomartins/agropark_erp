<template>
       <q-card flat >
              ...
              <q-card-section>
               ...
               <q-card-section class="q-pt-none">
                <q-input type="email" outlined v-model="email" label="Email" :dense="dense" />
              </q-card-section>

              <q-card-section class="q-pt-none">
                <q-select color="grey-3"  outlined :dense="dense" emit-value v-model="role" :options="$store.state.users.dependencies.roles" label="Role">
                </q-select>
              </q-card-section>
...
export default {
  ...
  methods: {
    update(){ this.$store.dispatch('users/update',this); },
