...
export default {
  ...
  methods: {
    ...
    editItem(payload) {
      ...
      this.$store.commit("users_details/UPDATE_EDIT_KIN_FORM_DATA", payload);
      this.$store.commit(
        "admin_layout/UPDATE_COMPONENT_NAME",
        "app-users-kin-update-form"
      );
    ...
    showCreateForm() {
      ...
      this.$store.commit(
        "admin_layout/UPDATE_COMPONENT_NAME",
        "app-users-kin-create-form"
      );
      this.$store.commit("admin_layout/UPDATE_RIGHT_DRAWER_OPEN", true);
    },
    async showKins() {
      this.$store.dispatch("users_details/fetchKins", this);
    }
  }
};
</script>
